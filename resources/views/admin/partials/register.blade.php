               ...
               <div class="row flex-grow">
                  <div class="col-lg-4 mx-auto">
                     <div class="auth-form-light text-left p-5">
                        ...
                        <form method="POST" action="/store_register" class="pt-3">
                           @csrf
                           <div class="form-group">
                              <input type="text" class="form-control form-control-lg" name="username" value="{{ old('username') }}" id="exampleInputUsername1" placeholder="Username">
                           ...
                           <div class="text-center mt-4 font-weight-light"> Already have an account? <a href="/infinite_login" class="text-danger fw-bold mt-3" style="font-size: 14px;">Login</a>
                           </div>
                        </form>
                     </div>
                  </div>
